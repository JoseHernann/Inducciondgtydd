<script setup lang="ts">
  ...
  import { VInputFields } from './VInputFields';
    ...
    <div class="relative">
      ...
      <input
        ...
        :class="`
          ...
          ${
            props.borderColor
          } w-full pr-3 py-2 text-primary bg-transparent outline-none border focus:border-blue-200 shadow-sm rounded-lg placeholder:gray-100`"
      ...
      <div class="absolute inset-y-0 right-3 flex items-center pl-3">
        <EyeIcon
          ...
          class="w-4 h-4 text-black cursor-pointer stroke-primary"
